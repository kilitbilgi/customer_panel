        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                	...
                	<?php if(Session::get('success_info')){?><div style="margin-bottom:15px;"><div class="alert alert-success">Sipariş Başarıyla Oluşturuldu.</div></div><?php }?>
                	<?php if(Session::get('payment_success')){?><div style="margin-bottom:15px;"><div class="alert alert-success">Ödeme Başarıyla Tamamlandı.</div></div><?php }?>
                    <?php if(Session::get('payment_error')){?><div style="margin-bottom:15px;"><div class="alert alert-danger">Ödeme İptal Edildi.</div></div><?php }?>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            			...
            			<tbody>
	            			<?php 
								...
								<tr>
									...
									<td><a class="btn btn-xs btn-primary" href="<?php echo url('viewOrder/'.$order->id);?>">Görüntüle</a></td>
								</tr>
								<?php }
							?>
						</tbody>
					</table>
					<?php echo $user_info["orders"]->links();}else{?>
					<div class="alert alert-info">Henüz hiç sipariş oluşturmadınız.</div>
					<?php }?>
            	</div>
            </div>
            <!-- Modal -->
