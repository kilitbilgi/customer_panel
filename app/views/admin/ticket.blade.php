            ...
            <div class="row">
				<div class="col-lg-12">
                    <div class="panel-group" id="accordion">
                    	<?php foreach ($user_info["tickets"] as $value) {?>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                	...
                                	<a class="btn btn-primary btn-xs pull-right" style="color: #FFFFFF" href="<?php echo url('admin/viewTicket/'.$value->id);?>">Detayları Görüntüle</a>
                                </h4>
                            </div>
                    ...
                    <?php echo $user_info["tickets"]->links(); ?>
				</div>
            </div>
                        <!-- Modal -->
